...
if __name__ == '__main__':
    ...
    parser.add_option("-U", "--U",   type="float", default=3.0,  help="Coulomb repulsion")
    parser.add_option("-T", "--T",   type="float", default=0.02, help="Temperature")
    ...
    parser.add_option("-i", "--Nitt", type="int",   default=400,  help="Number of self-consistent iterations")
    parser.add_option("-m", "--mix",  type="float", default=0.6,  help="Mixing parameter")
